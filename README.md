...
* [(1) Слова, часто используемые в CSS-классах](https://github.com/yoksel/common-words), [(2) Типичные названия классов в HTML](https://github.com/ademaro/css-class-list/blob/main/README.md), [(3) Слова и сокращения в CSS-классах](https://github.com/nicothin/idiomatic-pre-CSS/blob/gh-pages/words_and_abbreviations.md)
...
* [Поверка дерева на классы по БЭМ](https://yoksel.github.io/html-tree/), [2](https://nglazov.github.io/bem-validator-page/)
...
* [Крутое видео про асинхронность](https://www.youtube.com/watch?v=cCOL7MC4Pl0) (Как работает цикл событий event loop)
...
* [Почему ваш веб-сайт должен быть меньше 14 КБ](https://habr.com/en/post/684836/)
